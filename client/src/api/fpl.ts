...
/**
 * Base URL for official FPL public API
 * Direct client-side fetching (no backend proxy)
 */
export const BASE_PROXY_URL = "https://fantasy.premierleague.com/api";
...
export const getBootstrap = () =>
  safeGet(`${BASE_PROXY_URL}/bootstrap-static/`);
